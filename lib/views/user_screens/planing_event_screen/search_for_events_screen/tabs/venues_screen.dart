...
class VenueTabScreen extends StatefulWidget {
  const VenueTabScreen({super.key});

  @override
  State<VenueTabScreen> createState() => _VenueTabScreenState();
}
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              Text(
                'Embarking on the journey of party planning can be a bit overwhelming! Here at Tap to Party, we’ve curated a diverse range of venues and vendors to assist you every step of the way.',
                style: AppTextStyles.plusJakartaSans.copyWith(
                  color: Colors.black,
                  fontSize: 14,
                  fontWeight: FontWeight.w400,
