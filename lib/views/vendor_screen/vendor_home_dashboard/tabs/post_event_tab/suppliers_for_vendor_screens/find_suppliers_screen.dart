            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: (){
                      navigateToPage(context: context, pageName: FindProductScreen());
                  ...
                  GestureDetector(
                    onTap: (){
                      navigateToPage(context: context, pageName: SuppliersListScreen());
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(5, (index) =>                   Container(
                    width: 177,
                    height: 166,margin: EdgeInsets.only(right: 10),
                    decoration: BoxDecoration(
                      boxShadow: [
                        BoxShadow(
                          color: Color(0x3F000000),
                                ...
                                children: [
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Row(
                                          children:List.generate(4, (index) => Icon(Icons.star,size: 15,color: Color(0xFFFF971E),))
